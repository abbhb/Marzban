...
JOB_CORE_HEALTH_CHECK_INTERVAL = config("JOB_CORE_HEALTH_CHECK_INTERVAL", cast=int, default=60)
JOB_CORE_HEALTH_CHECK_TIMEOUT = config("JOB_CORE_HEALTH_CHECK_TIMEOUT", cast=int, default=5)
JOB_CORE_HEALTH_CHECK_FAILURE_THRESHOLD = config(
    "JOB_CORE_HEALTH_CHECK_FAILURE_THRESHOLD", cast=int, default=2
)
